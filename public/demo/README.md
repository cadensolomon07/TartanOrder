...
## Verified recording on this demo Mac

The public V2 application `3bb09ba` was recorded successfully on September12,2026. The named video exists locally:149.92seconds,1280×800, silent. Five real Gemini responses passed the complete scripted journey; no rules fallback or page error occurred. Playback frames were visually inspected. See [the preserved evidence](../../evals/runs/production-browser-gemini-2026-09-12.json). The final receipt hold is time for the presenter to explain validation/Undo/confirmation. This is recorded typed input; actual human microphone trials remain pending. The video is intentionally a local backup, not a tracked public download.
