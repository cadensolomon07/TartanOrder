...
The public deployment remains `8d55268` at https://tartan-order.vercel.app, with A/C typed rules. The corrected B candidate is available only on this Mac at http://127.0.0.1:3140. All automated voice evidence is mocked; human microphone success remains unverified. Core/contracts are unchanged, Gemini remains unverified and disabled, and direct audio remains deferred.
