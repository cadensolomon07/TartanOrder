...
- Select a real campus counter while a restriction is active. The catalog's published names/prices do not establish complete ingredient or preparation evidence, so uncertain items are not recommended as compatible.
