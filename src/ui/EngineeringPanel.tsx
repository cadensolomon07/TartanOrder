    ...
    <section className={styles.eng}>
      ...
      {open && (
        <div id="eng-body" className={styles.engBody} data-testid="eng-body">
          <p className={styles.muted}>An explicit log download includes transcripts, food requirements and special requests. Keep it private unless you choose to share it.</p>
