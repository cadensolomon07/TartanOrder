...
import { API_VERSION, MENU_VERSION, OrderViewSchema, PUBLIC_LOCATION_IDS, type ItemId, type Op, type ParseResponse, type RequirementChange, type UiAction } from "@/contracts";
import { createEngine, exportLog, getView, reduceEngine, replayLog, type EngineState } from "@/core/engine";

const setup = () => createEngine("meal-lifecycle", undefined, PUBLIC_LOCATION_IDS);
